...
+ (instancetype)bk_actionSheetWithTitle:(NSString *)title destructiveTitle:(NSString *)destructiveTitle otherButtonTitles:(NSArray *)buttonTitles cancelButtonTitle:(NSString *)cancelButtonTitle andDidDismissBlock:(void (^)(UIActionSheet *, NSInteger))block{
    ...
    if (cancelButtonTitle) {
        [actionSheet bk_setCancelButtonWithTitle:cancelButtonTitle handler:nil];
    }
